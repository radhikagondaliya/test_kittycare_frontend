      ...
      <div className={`m-auto sm:w-[600px] max-w-[90%] px-[21px] sm:px-[80px] bg-white border-2 rounded-3xl border-[#B8B8B8] mt-8 ${isPhone ? 'py-[47px] sm:py-[70px] ' : 'pb-[47px] sm:pb-[70px]'}`}>
        ...
        <div className="w-full h-full flex flex-col items-center justify-center">
          ...
          <div className='mt-8 space-x-4'>
            <button onClick={handleGoogleLogin} className='w-14 h-14 p-3 border-2 rounded-[20px] border-mediumGray'>
              <img src='/assets/svg/google-login.svg' alt='' />
            </button>
            <button className='w-14 h-14 p-3 border-2 rounded-[20px] border-mediumGray'>
              <img src='/assets/svg/apple-login.svg' alt='' />
            </button>
          </div>
        </div>
      </div>
